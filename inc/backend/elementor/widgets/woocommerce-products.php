...
class xConnect_WooCommerce_Products extends Widget_Base {
    ...
    public function get_title() {
        return __( 'WooCommerce Products', 'xconnect' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'product_title_color',
            [
                'label' => __( 'Product Title Color', 'xconnect' ),
        ...
        $this->add_control(
            'product_price_color',
            [
                'label' => __( 'Product Price Color', 'xconnect' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
...
Plugin::instance()->widgets_manager->register( new xConnect_WooCommerce_Products() );
