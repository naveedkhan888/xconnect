 ...
 * Widget Name: Button
 */
class xConnect_Features_Service extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Features Service', 'xconnect' );
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Service Title', 'xconnect' ),
				'placeholder' => __( 'Service Title', 'xconnect' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'xconnect' ),
			]
		);
		$repeater->add_control(
			'link',
		...
		$this->add_control(
			'fservice_lists',
			[
				'label' => __( 'Features Service List Items', 'xconnect' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'fservice_number' => __( '01', 'xconnect' ),
						'fservice_title' => __( 'Title #1', 'xconnect' ),
						'fservice_content' => __( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'xconnect' ),
						'link' => '#',
					],
					[
						'fservice_number' => __( '02', 'xconnect' ),
						'fservice_title' => __( 'Title #2', 'xconnect' ),
						'fservice_content' => __( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'xconnect' ),
						'link' => '#',
					],
				],
		...
		$this->add_control(
			'btn_text',
			[
				'label' => __( 'Label Button', 'xconnect' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More', 'xconnect' ),
			]
		);
...
// After the xConnect_Features_Service class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new xConnect_Features_Service() );