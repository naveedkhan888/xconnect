 ...
 */
class xConnect_Image_Box extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Image Box', 'xconnect' );
	}
...
// After the xConnect_Image_Box class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new xConnect_Image_Box() );