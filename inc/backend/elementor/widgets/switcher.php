 ...
 */
class xConnect_Switcher extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Switcher(Pricing Table)', 'xconnect' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'title_left',
			[
				'label' => __( 'Title Left', 'xconnect' ),
				'type' => Controls_Manager::TEXT,
                'default' => __( 'Monthly', 'xconnect' ),
                'label_block' => true,
			]
        );
        $this->add_control(
			'title_right',
			[
				'label' => __( 'Title Right', 'xconnect' ),
				'type' => Controls_Manager::TEXT,
                'default' => __( 'Yearly', 'xconnect' ),
                'label_block' => true,
			]
		);
...
Plugin::instance()->widgets_manager->register( new xConnect_Switcher() );