( function( $ ) {
    ...
    * --------------------------------------------------*/
	...
	$('#btn-loadmore').on('click',function(){
		...
		$.ajax({
			url : xconnect_loadmore_params.ajaxurl, // AJAX handler
			data : {
	...
	* --------------------------------------------------*/
	...
	$('.xconnect_block_hidden').hide();
	swt.on( 'change', function() {
		var parent = $(this).parents('.e-parent');
		if(this.checked) {
			parent.find('.r-switch').addClass('active');
			parent.find('.l-switch').removeClass('active');
			parent.find('.xconnect_block_show').hide();
			parent.find('.xconnect_block_hidden').show();
		}else{
			parent.find('.l-switch').addClass('active');
			parent.find('.r-switch').removeClass('active');
			parent.find('.xconnect_block_hidden').hide();
			parent.find('.xconnect_block_show').show();
		}
	});
